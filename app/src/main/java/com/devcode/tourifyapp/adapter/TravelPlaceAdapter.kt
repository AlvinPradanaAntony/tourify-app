...
import com.devcode.tourifyapp.data.remote.response.DestinationItem
import com.devcode.tourifyapp.databinding.ItemsPlaceBinding
import com.devcode.tourifyapp.ui.detail.DetailActivity

class TravelPlaceAdapter(private val listData: List<DestinationItem>): RecyclerView.Adapter<TravelPlaceAdapter.ViewHolder>() {
